...
import io.github.rebokdev.showCase.widgets.Picture
import io.github.rebokdev.showCase.widgets.Shape
import io.github.rebokdev.showCase.widgets.Text
...
internal fun generatePPTX(presentation: Presentation): ByteArray {
    val result = XMLSlideShow()
    val fileOut = ByteArrayOutputStream()
    val presentationSize = result.pageSize

    presentation.slides.forEachIndexed { index, slideRaw ->
